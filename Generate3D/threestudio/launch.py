...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--log_job_finish",
        default=None,
        help="to log job is finished for zero123",
    )
    ...
    if args.gradio:
        ...
        with contextlib.redirect_stdout(sys.stderr):
            img_path = main(args, extras)
    else:
        img_path = main(args, extras)

    if args.log_job_finish is not None:    
        print('training completed... ', img_path.replace('.png', '_{}.txt'.format(str(args.log_job_finish))))
        os.system('''touch "{}"'''.format(img_path.replace('.png', '_{}.txt'.format(str(args.log_job_finish)))))
...
class SingleImageDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None) -> None:
        if self.cfg.stage != "": stage = "structural_consistency"
        if stage in [None, "fit", "structural_consistency"]:
        ...
        if stage in [None, "structural_consistency"]:
            self.test_dataset = SingleImageDataset(self.cfg, "structural_consistency")

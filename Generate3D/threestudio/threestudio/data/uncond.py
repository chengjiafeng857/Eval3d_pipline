...
class RandomCameraDataset(Dataset):
    def __init__(self, cfg: Any, split: str) -> None:
        ...
        azimuth_deg: Float[Tensor, "B"]
        if self.split == "structural_consistency":
            azimuth_deg = torch.tensor([0., 90., 180., 270., 360.])
            self.n_views = azimuth_deg.shape[0]
            print("structural consistency metric will be evaluated at: ", azimuth_deg)
        elif self.split == "val":
